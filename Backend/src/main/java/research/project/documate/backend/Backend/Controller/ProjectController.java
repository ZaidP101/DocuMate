...
import research.project.documate.backend.Backend.DTOs.ProjectWithReadmeDTO;
...
public class ProjectController {
    ...
    public  ResponseEntity<ProjectWithReadmeDTO> getProject(@PathVariable Long projectId) {
